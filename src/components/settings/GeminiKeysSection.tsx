...
export function GeminiKeysSection() {
    ...
    <>
      <AdminCard>
        <Stack
          ...
          sx={{ mb: 2, alignItems: { sm: 'center' }, justifyContent: 'space-between', gap: 2 }}
        >
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              Add and name multiple Gemini keys. Each key is verified with Google before save.
            </Typography>
          </Box>
                ...
                {keys.map((key) => (
                  <TableRow key={key.id} hover>
                    ...
                    <TableCell align="right">
                      <IconButton size="small" onClick={() => openEditDialog(key)} aria-label="edit">
      ...
      <Dialog open={dialogOpen} onClose={closeDialog} maxWidth="sm" fullWidth>
        <DialogTitle>{editingKey ? 'Edit Gemini key' : 'Add Gemini key'}</DialogTitle>
        <DialogContent>
          {isSaving && (
